...
public class MainActivity extends AppCompatActivity {
    ...
    // Do 2 - 7 in menu.xml ///////////////////////////////////////////////////////////////////////
    //  (2) Created a menu xml called 'main.xml' in the res->menu folder
    // (3) Added one menu item to your menu
    //  (4) Given the menu item an id of @+id/action_search
    ...
    //  (9) Within onCreateOptionsMenu, used getMenuInflater().inflate to inflate the menu
    //  (10) Returned true to display your menu
    ...
    //  (12) Within onOptionsItemSelected, got the ID of the item that was selected
