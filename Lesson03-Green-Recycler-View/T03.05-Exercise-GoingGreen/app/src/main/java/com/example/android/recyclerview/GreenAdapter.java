...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        // viewHolderCount (13) Use ColorUtils.getViewHolderBackgroundColorFromInstance and pass in a Context and the viewHolderCount
        // viewHolderCount (14) Set the background color of viewHolder.itemView with the color from above
        int color = ColorUtils.getViewHolderBackgroundColorFromInstance(viewGroup.getContext(),viewHolderCount);
        viewHolder.itemView.setBackgroundColor(color);
        // viewHolderCount (15) Increment viewHolderCount and log its value
        viewHolderCount++;
        Log.d(GreenAdapter.TAG,"\n"+viewHolder);
        return viewHolder;
    }
